...
insert into authors (id,"username","password","role") values (1,'budi','Budi123!','user');
insert into authors (id,"username","password","role") values (2,'tono','Tono123!','admin');
insert into authors (id,"username","password","role") values (3,'susi','Tono123!','guest');

 
CREATE TABLE public.endpontacces (
	id serial4 NOT NULL,
	"roles"  varchar[] NOT NULL,
	"path"  varchar  NOT Null,
	CONSTRAINT endpontacces_pkey PRIMARY KEY (id)
);
INSERT INTO public.endpontacces ("roles","path") VALUES ((ARRAY['admin', 'user']),'/getData');
